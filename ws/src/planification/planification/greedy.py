...
# En lugar de una cola, usaremos una lista de prioridad para el algoritmo Greedy
...
class GREEDYSolverNode(Node):
    ...
    def solve(self):
        ...
        # Implementa el algoritmo Greedy para encontrar la ruta óptima
        ...
        while not priority_queue.empty():
            ...
            for dx, dy in [(1, 0), (-1, 0), (0, 1), (0, -1)]:
                ...
                if is_valid(nx, ny) and (nx, ny) not in visited:
                    priority = math.sqrt((nx - end_x) ** 2 + (ny - end_y) ** 2)
